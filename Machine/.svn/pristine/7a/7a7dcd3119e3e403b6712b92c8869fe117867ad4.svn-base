...
/**
 * TDetectionItem2018 entity. @author MyEclipse Persistence Tools
 */

public class TDetectionItem2018 implements java.io.Serializable {
	...
	/** default constructor */
	public TDetectionItem2018() {
	}

	/** full constructor */
	public TDetectionItem2018(String id, Integer assayType, String result,
