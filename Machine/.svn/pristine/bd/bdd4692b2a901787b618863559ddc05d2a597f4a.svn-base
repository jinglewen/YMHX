...
/**
 * TDetectionMain2017 entity. @author MyEclipse Persistence Tools
 */

public class TDetectionMain2017 implements java.io.Serializable {
	...
	/** default constructor */
	public TDetectionMain2017() {
	}

	/** minimal constructor */
	public TDetectionMain2017(String id, String batchNumber, Integer createrId,
