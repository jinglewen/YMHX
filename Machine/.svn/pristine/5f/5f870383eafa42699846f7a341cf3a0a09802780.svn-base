...
/**
 * TDetectionMain2016 entity. @author MyEclipse Persistence Tools
 */

public class TDetectionMain2016 implements java.io.Serializable {
	...
	/** default constructor */
	public TDetectionMain2016() {
	}

	/** minimal constructor */
	public TDetectionMain2016(String id, String batchNumber, Integer createrId,
