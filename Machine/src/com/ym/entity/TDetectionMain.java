...
/**
 * TDetectionMain entity. @author MyEclipse Persistence Tools
 */

public class TDetectionMain implements java.io.Serializable {
	...
	/** default constructor */
	public TDetectionMain() {
	}

	/** minimal constructor */
	public TDetectionMain(String id, String batchNumber, Integer createrId,
