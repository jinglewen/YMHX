...
/**
 * TDetectionItem2016 entity. @author MyEclipse Persistence Tools
 */

public class TDetectionItem2016 implements java.io.Serializable {
	...
	/** default constructor */
	public TDetectionItem2016() {
	}

	/** full constructor */
	public TDetectionItem2016(String id, Integer assayType, String result,
