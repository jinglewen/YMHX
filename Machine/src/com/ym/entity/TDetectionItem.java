...
/**
 * TDetectionItem entity. @author MyEclipse Persistence Tools
 */

public class TDetectionItem implements java.io.Serializable {
	...
	/** default constructor */
	public TDetectionItem() {
	}

	/** full constructor */
	public TDetectionItem(String id, Integer assayType, String result,
